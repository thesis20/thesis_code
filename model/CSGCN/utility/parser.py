...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='loo_yelpnc',
    ...
    parser.add_argument('--embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--layer_size', nargs='?', default='[64,64,64,64,64]',
    ...
    parser.add_argument('--adj_type', nargs='?', default='csgcn',
                        help='Specify the type of the adjacency (laplacian) matrix from {rwalk, csgcn, pre, plain, norm, mean}.')
